...
<body>
    <header>
        <nav>
            <div class="logo">
                <button onclick="window.location.href = 'in_index.php';" class="logobutton"></a><img src="Images/logo.png" alt="SkinABCs"></button>
            </div>
            <ul>
        ...
        <div class="serums">
            <div id="sensnia-loc" class="sensnia-serum">
                ...
                <div class="sensnia-text">
                    ...
                    <h3>₱255</h3>
                    <h5><button onclick="location.href='in_checkout.php';"> Checkout Now </button></h5><br><br>
