        ...
        <div class="container">
                    ...
                    <div class="product">
                        ...
                        <div class="product-contents">
                            ...
                            <div class="number-input">
                                ...
                                <input class="quantity" id="sensniaQuantity" min="0" name="quantity" value="0" type="number">
                    ...
                    <div class="product">
                        ...
                        <div class="product-contents">
                            ...
                            <div class="number-input">
                                ...
                                <input class="quantity" id="ubQuantity" min="0" name="quantity" value="0" type="number">
                    ...
                    <div class="product">
                        ...
                        <div class="product-contents">
                            ...
                            <div class="number-input">
                                ...
                                <input class="quantity" id="oaproneQuantity" min="0" name="quantity" value="0" type="number">
            ...
            <div class="right">   
                <div class="total">
                    ...
                    <h2> Number of Items: <p style="float: right;" id="items"> 0 </p></h2>
                    <h2> Total Price: <p style="float: right;" id="total"> P </p> </h2>
                    <hr>
                    <button onclick="validationPopup()"> Proceed to Checkout </button>
                    <p class="cod"><i class="bi bi-cash"></i> Only available for cash on delivery! <p>
                </div>
            </div>
        </div>
